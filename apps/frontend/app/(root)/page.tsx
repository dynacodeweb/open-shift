        ...
        <div className={'text-center space-y-8'}>
          ...
          <div className={'grid grid-cols-1 lg:grid-cols-2 gap-6'}>
            ...
            <div className={'relative'}>
              ...
              <div
                className={
                  'absolute bottom-0 right-0 lg:bottom-8 lg:right-8 rounded-4xl overflow-hidden'
                }>
                <CircularText
                  text='YEARS*OF*EXPERIENCE*'
                  onHover='slowDown'
                  spinDuration={15}
                  className='text-primary! size-44 sm:size-48'
                />
                <span
                  className={cn(
                    'absolute inset-0 flex items-center justify-center font-black text-4xl text-primary',
                  )}>
                  10+
                </span>
              </div>
